...
public class Notes_7_3_Examples {
    public static void main(String[] args) {
        ...
        System.out.println("# of even values: " + evenCount);
        // Call countEvensForEach and print the result
        evenCount = countEvensForEach(vals);
        System.out.println("# of evens w/ forEach: " + evenCount);
        ...
        // print list1
        System.out.println("Array removeEvensForward: " + list1);
        // Call removeEvensBackward on list2
        removeEvensBackward(list2);
        // print list2
        System.out.println("Array removeEvensBackward: " + list2);
